...
const CompanyRegistration = () => {
    const [formData, setFormData] = useState({
        ...
        contact: '',
        description: '',
        year: '' // ADDED: Required for nested schema
    });
    ...
    return (
        <form onSubmit={handleSubmit} className="registration-form">
            <h2>Company Registration</h2>
            <input name="companyName" placeholder="Company Name" value={formData.companyName} onChange={handleChange} required /><br />
            ...
            <input name="contact" placeholder="Contact Number" value={formData.contact} onChange={handleChange} required /><br />
            ...
            <textarea name="description" placeholder="Company Description" value={formData.description} onChange={handleChange} /><br />
            <button type="submit">Register</button>
        </form>
    );
}
